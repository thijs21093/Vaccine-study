...
**Expertise:**
```{r}
tadaa_t.test(data = df.def.NL, response = credibility.expert, group = experimental.group, print = "markdown")
```
...
**Stability:**
```{r}
tadaa_t.test(data = df.def.NL, response = credibility.stability, group = experimental.group, print = "markdown")
```
...
**Non-interference:**
```{r}
tadaa_t.test(data = df.def.NL, response = credibility.noninterference, group = experimental.group, print = "markdown")
```
