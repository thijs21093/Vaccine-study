---
title: "Report COVID study EN TEST"
...
```{r}
load("C:/Users/Thijs/surfdrive/COVID vaccine/R data/EN/.RData")
...
plot_frq((intro.submit),
  ...
  scale_x_continuous(name="Time in seconds",breaks = seq(0,100,5)) + ylim(0, 65) + annotate(geom = "table", x = Inf, y = Inf, label = list(table.intro.submit))
```
...
plot_frq((manipulation.submit),
        ...
        geom.size = 1) +
  theme(axis.text = element_text(face = "bold",  size= 9)) +
  scale_x_continuous(name="Time in seconds",breaks = seq(0,100,5)) + ylim(0, 65) + annotate(geom = "table", x = Inf, y = Inf, label = list(table.manipulation.submit))
```
...
plot_frq((decision.submit),
        ...
        geom.size = 1) + 
  theme(axis.text = element_text(face = "bold",  size= 9)) +
  scale_x_continuous(name= "Time in seconds", breaks = seq(0,100,5)) + ylim(0, 65) + annotate(geom = "table", x = Inf, y = Inf, label = list(table.decision.submit))
```
 ...
 * Compare: https://www.cso.ie/en/releasesandpublications/ep/p-cp10esil/p10esil/le/
...
reg.perceived.independence2 <- lm(perceived.independence.reversed ~  intent.vaccine + trust.politicians + trust.scientist + trust.health.authorities + benefits.vaccines + credibility.EMA + familiarity.EMA + political.ideology + EU.integration + knowledge + interpersonal.trust + experimental.group +  female + poly(age, 2) + healthcare + income + education.recoded,
                    data = df.def,
                    na.action = na.omit)

reg.perceived.independence3 <- lm(perceived.independence.reversed ~ intent.vaccine + credibility.index + trust.politicians + trust.scientist + trust.health.authorities + benefits.vaccines + credibility.EMA + familiarity.EMA + political.ideology + EU.integration + knowledge + interpersonal.trust + experimental.group + female + poly(age, 2) + healthcare + income + education.recoded,
                    data = df.def,
                    na.action = na.omit)

tab_model(reg.perceived.independence1, reg.perceived.independence2, reg.perceived.independence3, show.ci = FALSE)
```
...
reg.intent.vaccine3 <- lm(intent.vaccine ~ credibility.index + perceived.independence.reversed + trust.politicians + trust.scientist + trust.health.authorities + benefits.vaccines + credibility.EMA + familiarity.EMA + political.ideology + interpersonal.trust + EU.integration + knowledge + experimental.group +  female + poly(age, 2) + healthcare + income + education.recoded,
                    data = df.def,
                    na.action = na.omit)

tab_model(reg.intent.vaccine1, reg.intent.vaccine2, reg.intent.vaccine3, show.ci = FALSE)
```
...
reg.credibility2 <- lm(credibility.index  ~ intent.vaccine + trust.politicians + trust.scientist + trust.health.authorities + benefits.vaccines + credibility.EMA + familiarity.EMA + political.ideology + interpersonal.trust + EU.integration + knowledge + experimental.group + female + poly(age, 2) + healthcare + income + education.recoded,
                    data = df.def,
                    na.action = na.omit)

reg.credibility3 <- lm(credibility.index  ~ intent.vaccine + perceived.independence.reversed + trust.politicians + trust.scientist + trust.health.authorities + benefits.vaccines + credibility.EMA + familiarity.EMA + political.ideology + interpersonal.trust + EU.integration + knowledge + experimental.group + female + poly(age, 2) + healthcare + income + education.recoded,
                    data = df.def,
                    na.action = na.omit)

tab_model(reg.credibility1, reg.credibility2, reg.credibility3, show.ci = FALSE)
```
