...
```{r}
ggline(df.def, x = "manipulation.submit.30", y = "perceived.independence.reversed", color = "experimental.group", ylab = "Perceived independence", xlab = "Page submission - manipulation",  add = c("mean_se"), ylim = c(3, 4.25), yticks.by = 0.25) +
  stat_summary(fun.data = give.n, geom = "text", fun = median, size = 4, col = "black")
```
