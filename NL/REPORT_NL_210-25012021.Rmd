---
title: "Report COVID study NL  211"
...
```{r}
load("C:/Users/Thijs/surfdrive/COVID vaccine/R data/git/NL/.RData")
...
```{r}
tadaa_t.test(data = df.def, response = duration, group = experimental.group, print = "markdown")
tadaa_t.test(data = df.def, response = intro.submit, group = experimental.group, print = "markdown")
tadaa_t.test(data = df.def, response = manipulation.submit, group = experimental.group, print = "markdown")
tadaa_t.test(data = df.def, response = decision.submit, group = experimental.group, print = "markdown")
```
...
age.population.5 <- read.csv("C:/Users/Thijs/surfdrive/COVID vaccine/R data/git/NL/AGE_POPULATION_SEGMENTS_NL-22012021.csv")
...
Compare with true population:
 ...
 ![Source: CBS.](C:/Users/Thijs/surfdrive/COVID vaccine/R data/git/NL/education.jpeg)
...
Compare with true population:
```{r}
provinces <- read.csv("C:/Users/Thijs/surfdrive/COVID vaccine/R data/git/NL/PROVINCES_NL-22012021.csv")
