...
Judging this table,  it seems that item 1 may be better assigned to the 'expertise' factor, instead of the 'non-interference' factor. Also, note the very high correlation between non-interference and expertise and the somewhat low loadings of item 2 and item 3. The next model shows what happens if item 1 is assigned to the 'expertise' factor.
