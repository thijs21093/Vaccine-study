...
"15. FAmiliarity with EMA's advice",
...
"21. Importance of EMA's advice",
"22. Importance of other regulators' advice",
"23. Importance of NRA's advice",
...
ggarrange(pooled  %>% ggplot(aes(x = experimental.group, y = perceived.independence.reversed, color = experimental.group)) +
    ...
    pooled %>% filter(manipulation.check.failed == "passed") %>% ggplot(aes(x = experimental.group, y = perceived.independence.reversed, color = experimental.group)) +
      stat_summary(fun.data = mean_cl_normal, geom = "errorbar", alpha = 0.5, width = 0.1, size = 1, position = position_dodge(0.5)) + labs(color ='Experimental group', x = "", y = "", title = "Only those who passed the manipulation check") +
